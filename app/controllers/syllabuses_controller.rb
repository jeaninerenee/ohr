class SyllabusesController < ApplicationController
  ...
  private
    ...
    def syllabus_params
      params.require(:syllabus).permit(:auth_account_id, :grade_id, :activity_id, :syllabus_name, :version_number, :syllabus_note, :teacher_note, :status_id, :updated_by, :created_by)
    end
end
