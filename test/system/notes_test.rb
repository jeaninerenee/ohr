...
class NotesTest < ApplicationSystemTestCase
  ...
  test "creating a Note" do
    ...
    fill_in "Auth account", with: @note.auth_account_id
    fill_in "Created by", with: @note.created_by
    fill_in "Note", with: @note.note
    fill_in "Note date", with: @note.note_date
    fill_in "Status", with: @note.status_id
    fill_in "Updated by", with: @note.updated_by
