...
class SubjectsTest < ApplicationSystemTestCase
  ...
  test "creating a Subject" do
    ...
    fill_in "Auth account", with: @subject.auth_account_id
    fill_in "Created by", with: @subject.created_by
    fill_in "Status", with: @subject.status_id
    fill_in "Subject name", with: @subject.subject_name
    fill_in "Subject order", with: @subject.subject_order
    fill_in "Updated by", with: @subject.updated_by
